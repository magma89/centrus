...
//	}
	...
	@PostMapping("/add")
	public ResponseEntity<Object> createAssignGroup(@RequestBody QueueAgentGroup newGroup){
		try {
			return assignGroupQueueServices.createGroup("Success",HttpStatus.OK,newGroup);
		}catch(Exception e) {
			return assignGroupQueueServices.createGroup(e.getMessage(),HttpStatus.MULTI_STATUS,null);
		}
	}
}
